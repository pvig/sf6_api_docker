      ...
      <div class="card">
        ...
        <v-form ref="form" @submit.prevent="validate" id="client-form">
          <v-container>
            <v-row>
              <v-col cols="12" md="12">
                <v-text-field :value="localClient.nom"  @input="update('nom', $event)" label="Nom" :rules="rules.required" ></v-text-field>
                <v-text-field :value="localClient.prenom"  @input="update('prenom', $event)" label="Prenom" :rules="rules.required" ></v-text-field>
                <v-text-field :value="localClient.email"  @input="update('email', $event)" label="Email" :rules="rules.email" ></v-text-field>
